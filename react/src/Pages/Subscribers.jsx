                                    ...
                                    <div className="container-fluid px-3 pb-3">
                                        <div className="row g-2 g-lg-3 pt-3 user_row">
                                            ...
                                            <div className="col-sm-4 text-center text-sm-end">
                                                <button type="button" className="btn btn-sm fw-normal btn-primary float-sm-end my-common-radius fs-xs" data-bs-toggle="modal" data-bs-target="#addSubscriberModal" onClick={resetForm}>
                                                    <i className="ri-add-line fs-18 lh-1"></i>Add New Subscriber
                                                </button>
                                            </div>
                                        </div>
