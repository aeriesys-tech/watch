        ...
        {loading ? (
          ...
          <>
            ...
            <div className="container-fluid mt-28">
                <div className="row">
                    <div className="col">
                    <h5 className="text-uppercase rate-short-symbol card_title_evry">Profile</h5>
                    </div>
                </div>
            </div>
                    ...
                    <div className="form-group">
                      ...
                      <input
                        ...
                        className={`form-control ${
                          profileErrors.avatar ? "is-invalid" : ""
                        }`}
                        id="customFile"
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-6 mb-3">
                          ...
                          <input
                            ...
                            className={`form-control ${
                              profileErrors.mobile_no ? "is-invalid" : ""
                            }`}
                            value={mobileNo}
                        ...
                        <div className="col-md-12 mb-3">
                          ...
                          <textarea
                            ...
                            placeholder="Address"
                            className={`form-control ${
                              profileErrors.address ? "is-invalid" : ""
                            }`}
                            value={address}
