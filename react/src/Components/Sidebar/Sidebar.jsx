...
//   // Prevent event propagation when clicking on dropdown items
...
//           <div class="nav-group">
//             <Link to="/dashboard" class="nav-label no_icon">
...
//                       <i className="ri-pie-chart-2-line"></i> <span>Units</span>
//                     </Link>
//                   </li>
//                 )}
...
//             <div class="nav-group">
//               <Link to="/clients" class="nav-label no_icon">
...
function Sidebar() {
  ...
  useEffect(() => {
    ...
    // Set the isDropdownOpen1 to true if the current path matches any of the Configure routes
    if (
      path.includes("/deviceTypes") ||
      path.includes("/units") ||
      path.includes("/checkGroups") ||
      path.includes("/checkParameters") ||
      path.includes("/permissions")
    ) {
      setIsDropdownOpen1(true);
    }

    // Set the isDropdownOpen to true if the current path matches any of the User Management routes
      ...
      <div className="header-main px-3 px-lg-4">
        ...
        <div className="dropdown dropdown-notification ms-3 ms-xl-4">
          ...
          <div className="dropdown-menu dropdown-menu-end mt-10-f me--10-f">
            ...
            <ul className="list-group">{/* Notification items */}</ul>
            <div className="dropdown-menu-footer">
