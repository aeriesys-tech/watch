                    ...
                    <div className="container">
                        <div className="card card-auth">
                            <div className="card-body text-center">
                                <div className="mb-3">
                                    <img src="../assets/img/Bespoke_logo_svg 1.png" alt="Logo" />
                                </div>
                                <h4 className="card-title1 text-dark">Forgot your password</h4>
                                <p className="card-text mb-4">Enter your username or email address and we will send you a link to reset your password.</p>
