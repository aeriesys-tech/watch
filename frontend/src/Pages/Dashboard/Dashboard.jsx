        ...
        <>
            <div class="sidebar">
                ...
                <div id="sidebarMenu" class="sidebar-body">
                    <div class="nav-group">
                        <a href="/dashboard" class="nav-label no_icon"><i class="ri-dashboard-line"></i><span>Dashboard</span></a>
                    </div>
                    <div class="nav-group">
                        <a href="gds" class="nav-label">
                            <i class="ri-user-settings-line"></i>
                            <span>Configue</span></a>
                    ...
                    <div class="nav-group">
                        <a href="Users.html" class="nav-label no_icon"><i class="ri-group-line"></i><span>Users</span></a>
                    </div>
                    <div class="nav-group">
                        <a href="asd" class="nav-label"><i class="ri-file-text-line"></i><span>Reports</span></a>
                        <ul class="nav nav-sidebar">
                            <li class="nav-item">
                                <a href="../dashboard/finance.html" class="nav-link"><i class="ri-pie-chart-2-line"></i> <span>Finance Monitoring</span></a>
                            </li>
            ...
            <div class="header-main px-3 px-lg-4">
                ...
                <div class="me-auto">
                    <svg xmlns="http://www.w3.org/2000/svg" width="131" height="30" viewBox="0 0 141 40" fill="none">
                        <path d="M77.2272 15.8748H69.5273V30.7393H77.2272V15.8748Z" fill="#004381" />
                        <path d="M66.9821 15.8757H48.6524L47.2017 18.1226V18.3065H53.9775V30.7394H61.6774V18.3065H68.4472V18.1226L66.9821 15.8757Z" fill="#004381" />
                        <path d="M79.7727 15.8757H98.1024L99.551 18.1226V18.3065H92.7772V30.7394H85.0774V18.3065H78.3076V18.1226L79.7727 15.8757Z" fill="#004381" />
                        <path d="M109.023 28.0307L110.486 30.7403H118.801V30.5536L110.747 15.8738H102.992L94.1641 30.5536V30.7403H99.401L100.841 28.0307H109.023ZM101.975 25.6697L105.008 19.9732L107.78 25.6697H101.975Z" fill="#004381" />
                        <path d="M123.263 15.8757L135.305 23.7705V15.8757H139.587V30.7394H135.478L123.737 23.1209V30.7394H119.57V15.8757H123.263Z" fill="#004381" />
                        <path
                            fill-rule="evenodd"
                            clip-rule="evenodd"
                ...
                <div class="dropdown dropdown-notification ms-3 ms-xl-4">
                    <a href="s" class="dropdown-link" data-bs-toggle="dropdown" data-bs-auto-close="outside"><small>3</small><i class="ri-notification-3-line"></i></a>
                    <div class="dropdown-menu dropdown-menu-end mt-10-f me--10-f">
                        ...
                        <div class="dropdown-menu-footer"><a href="q">Show all Notifications</a></div>
                    </div>
                </div>
                <div class="dropdown dropdown-profile ms-3 ms-xl-4">
                    <a href="s" class="dropdown-link" data-bs-toggle="dropdown" data-bs-auto-close="outside">
                ...
                <div class="d-flex align-items-center justify-content-between mb-4">
                    <div>
                        <ol class="breadcrumb fs-sm mb-1">
                            <li class="breadcrumb-item"><a href="s">Dashboard</a></li>
                    ...
                    <nav class="nav nav-icon nav-icon-lg">
                        <a href="s" class="nav-link" data-bs-toggle="tooltip" title="Share"><i class="ri-share-line"></i></a>
                        <a href="s" class="nav-link" data-bs-toggle="tooltip" title="Print"><i class="ri-printer-line"></i></a>
                        <a href="s" class="nav-link" data-bs-toggle="tooltip" title="Report"><i class="ri-bar-chart-2-line"></i></a>
                    </nav>
                </div>
