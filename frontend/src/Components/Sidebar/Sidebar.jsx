        ...
        <>
            <div className="sidebar">
                ...
                <div id="sidebarMenu" className="sidebar-body">
                    <div className="nav-group">
                        <a href="/dashboard" className="nav-label no_icon"><i className="ri-dashboard-line"></i><span>Sidebar</span></a>
                    </div>
                    <div className="nav-group">
                        ...
                        <ul className="nav nav-sidebar">
                            <li className="nav-item">
                                <a href="../dashboard/finance.html" className="nav-link"><i className="ri-pie-chart-2-line"></i> <span>Finance Monitoring</span></a>
                            </li>
                            <li className="nav-item">
                                <a href="../dashboard/events.html" className="nav-link"><i className="ri-calendar-todo-line"></i> <span>Events Management</span></a>
                            </li>
                        </ul>
                    </div>
                    <div className="nav-group">
                        <a href="Users.html" className="nav-label no_icon"><i className="ri-group-line"></i><span>Users</span></a>
                    </div>
                    <div className="nav-group">
                        <a href="asd" className="nav-label"><i className="ri-file-text-line"></i><span>Reports</span></a>
                        <ul className="nav nav-sidebar">
                            <li className="nav-item">
                                <a href="../dashboard/finance.html" className="nav-link"><i className="ri-pie-chart-2-line"></i> <span>Finance Monitoring</span></a>
                            </li>
            ...
            <div className="header-main px-3 px-lg-4">
                ...
                <div className="dropdown dropdown-notification ms-3 ms-xl-4">
                    <a href="s" className="dropdown-link" data-bs-toggle="dropdown" data-bs-auto-close="outside"><small>3</small><i className="ri-notification-3-line"></i></a>
                    <div className="dropdown-menu dropdown-menu-end mt-10-f me--10-f">
                        ...
                        <div className="dropdown-menu-footer"><a href="q">Show all Notifications</a></div>
                    </div>
                </div>
                <div className="dropdown dropdown-profile ms-3 ms-xl-4">
                    ...
                    <div className="dropdown-menu dropdown-menu-end mt-10-f">
                        <div className="dropdown-menu-body">
                            <div className="avatar avatar-xl online mb-3"><img src="../assets/img/user.png" alt="" /></div>
